...
const { authenticateToken, handle404Error, csrfProtection, checkApiAccess, authenticateServiceToken } = require("../middlewares");
...
router.use("/internals/students",authenticateServiceToken, studentsRoutes);
